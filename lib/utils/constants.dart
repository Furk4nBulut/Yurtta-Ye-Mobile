...
class Constants {
  ...
  // Mavi tonları - baskın, ferah ve modern
  ...
  static const Color kykBlue400 = Color(0xFF5A7FE3);   // Parlak açık mavi
  static const Color kykBlue200 = Color(0xFFB6CCFF);   // Çok açık gökyüzü mavisi - ferahlatıcı

  // Mor tonları - vurgu için canlı ve dengeli
  static const Color kykOrange400 = Color(0xFF8257E5); // Canlı mor-menekşe tonu

  // Kırmızı tonları - sıcak ve dikkat çekici vurgu
  static const Color kykYellow400 = Color(0xFFE25757); // Yumuşak kırmızı - vurgu

  // Gri tonları - soğuk mavi alt tonlu, nötr ve temiz
  static const Color kykGray100 = Color(0xFFEFF3FF);   // Çok açık buz mavisi
  static const Color gray50 = Color(0xFFF8FAFF);       // Neredeyse beyaz, hafif mavi alt tonlu
  static const Color gray100 = Color(0xFFD7E1FF);      // Açık mavi-gri
  static const Color gray200 = Color(0xFFACBAF7);      // Hafif mavi-gri
  ...
  static const Color gray600 = Color(0xFF3E5396);      // Koyu mavi-gri (başlık/metin)

  static const Color kykGray700 = Color(0xFF2B3B70);   // Koyu mavi-gri
  static const Color gray700 = Color(0xFF1A2A54);      // Çok koyu mavi-gri

  // Kırmızı tonları - vurgu ve butonlar için canlı kırmızılar
  ...
  // Yeşil tonları - doğal, taze ve canlı

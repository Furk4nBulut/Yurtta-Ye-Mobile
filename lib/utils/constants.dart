...
class Constants {
  ...
  // Mavi tonları - daha canlı ve ferah, baskın renkler
  ...
  // Kırmızı tonları - vurgu ve buton için canlı kırmızı tonları
  ...
  // Yeşil tonları - doğal ve taze, biraz pastel ve yumuşak
